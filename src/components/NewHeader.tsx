              ...
              <div className="grid grid-cols-1 gap-y-10 pt-10 pb-16 sm:grid-cols-2 sm:pt-16">
                <div>
                  ...
                  <ul className="font-display text-base text-white">
                    <li><a className="py-2 block hover:opacity-90" href="/about">About</a></li>
                    <li><a className="py-2 block hover:opacity-90" href="/commission">Commissions</a></li>
                  </ul>
                ...
                <div className="sm:border-l sm:border-transparent sm:pl-16">
                  ...
                  <ul role="list" className="mt-6 flex gap-x-10 text-white">
                    ...
                    <li>
                      <a
                href="https://www.instagram.com/victoriaagambill/"
